...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'intelstellar@tpv.32mine.net',
  ...
  email: 'mailto:koishi@intelstellar.xyz',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/intelstellar',
    },
  ],
